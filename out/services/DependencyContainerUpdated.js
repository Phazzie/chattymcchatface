...
exports.DependencyContainerUpdated = void 0;
...
const CommandServiceRefactored_1 = require("./CommandServiceRefactored");
...
// Message handlers
const TextMessageHandler_1 = require("../network/handlers/TextMessageHandler");
const AuthMessageHandler_1 = require("../network/handlers/AuthMessageHandler");
const SystemMessageHandler_1 = require("../network/handlers/SystemMessageHandler");
const FileMessageHandlerFacade_1 = require("../network/handlers/FileMessageHandlerFacade");
const uuid_1 = require("uuid");
/**
 * Container for managing dependencies and their lifecycle.
 * Implements the Service Locator pattern.
 */
class DependencyContainerUpdated {
    /**
    ...
    initialize(context) {
        ...
        const textMessageHandler = new TextMessageHandler_1.TextMessageHandler(logger, messageHandler);
        this.registerService('textMessageHandler', textMessageHandler);
        const authMessageHandler = new AuthMessageHandler_1.AuthMessageHandler(logger, authService, messageHandler);
        this.registerService('authMessageHandler', authMessageHandler);
        const systemMessageHandler = new SystemMessageHandler_1.SystemMessageHandler(logger, messageHandler);
        this.registerService('systemMessageHandler', systemMessageHandler);
        const fileMessageHandler = new FileMessageHandlerFacade_1.FileMessageHandlerFacade(logger, messageHandler);
        ...
        const commandService = new CommandServiceRefactored_1.CommandServiceRefactored(context);
...
exports.DependencyContainerUpdated = DependencyContainerUpdated;
//# sourceMappingURL=DependencyContainerUpdated.js.map